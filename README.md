...
| 1 | Alta | Como estudando de logística espero poder entregar a Sprint 1 como sucesso e com os dados corretos                                                                                                                                       | 5 | 1 |
|------|------------|---------------------------------------------------------------------------------------------------------------------------------------------------------|------------|--------|
| 2   | Alta       | Como estudante de logística esperando entregar a Sprint 2 filtrada com os dados pesquisados                                                   | 5          | 2      |
| 2    | Alta       | Como atendente, quero gerenciar as solicitações de vistoria para agendar atendimento                                                                    | 8          | 3      |
| 3    | Alta       | Como estudante de logística espero que na Sprint 3 o trabalho já esteja praticamente finalizado com todos os dados                                              | 5          | 3      |
| ...  | Média      | ...                                                                                                                                                     | ...        | ...    |
